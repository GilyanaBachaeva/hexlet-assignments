...
public class GuestsController {
    ...
    public String registerGuest(@Valid @RequestBody GuestCreateDTO guestCreateDTO) {
        // Логика для регистрации гостя
        // Преобразование DTO в сущность и сохранение в базе данных
