...
class TaskControllerTest {
    ...
    public void testShow() throws Exception {
        // Создаем тестовую задачу с помощью Instancio
    ...
    public void testCreate() throws Exception {
        // Используем Select для создания задачи с определенными значениями
        Task task = Instancio.of(Task.class)
                .ignore(Select.field("id")) // Игнорируем поле id, чтобы оно генерировалось автоматически
                .create();
    ...
    // Пример использования HashMap (если это необходимо)
